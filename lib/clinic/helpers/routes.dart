const cloginRoute = "/loginc";
const csignupRoute = "/signupc";
const drsnProfileRoute = "/drsn_profile";
const createClinicRoute = "/create_clinic";

const clinicProfileRoute = "/clinic_profile";
const scanApptRoute = "/scan_appt";
const regApptRoute = "/reg_appt";
